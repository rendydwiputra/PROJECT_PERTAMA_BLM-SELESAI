...
const DetailProduct = (props) => {
    ...
    return (
        <div className="row detail_page">
            ...
            <h5 className="text-success">Rp{product.price}</h5>
            ...
            <div className="my-2 text-flex">{product.content}</div>
            <button type="button" className="btn btn-success d-block my-3 px-5"
            onClick={() => dispatch(addCart(product, cart))}>BELI SEKARANG</button>
            </div>
            </div>
    )
}
