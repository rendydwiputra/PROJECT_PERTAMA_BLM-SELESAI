...
const CartItem = ({item, dispatch, cart}) => {
    ...
    <tr>
        ...
        <td style={{minWidth: '200px'}} className= "w-50 align-middle">
            ...
            {
                    item.inStock > 0
                    ? <p className="mb-1 text-danger">Stock: {item.inStock}</p>
                    : <p className="mb-1 text-danger">Stock Habis</p>
            }
        </td>
        ...
        <i className="fas fa-trash" aria-hidden="true" data-toggle="modal" data-target="#exampleModal"
        onClick={() => dispatch({
            type: 'ADD_MODAL',
